...
public class EpcApp {
    ...
    public ConsistentMap<String, String> exmap;
    public Map<String, String> ex;
    public final InternalListener listener = new InternalListener();

    public ConsistentMap<String, String> uekey_ueip_map;
    public ConsistentMap<String, String> uekey_guti_map;
    public final InternalListener listener_ueip = new InternalListener();
    public final InternalListener listener_guti = new InternalListener();
	...
	uekey_ueip_map = storageService.<String, String>consistentMapBuilder()
                .withSerializer(Serializer.using(KryoNamespaces.API))
                .withName("uekey_ueip_map")
                .build();
        uekey_ueip_map.addListener(listener_ueip);
	log.info("Consistent uekey_ueip_map successfully listening");
	
	uekey_guti_map = storageService.<String, String>consistentMapBuilder()
                .withSerializer(Serializer.using(KryoNamespaces.API))
                .withName("uekey_guti_map")
                .build();
        uekey_guti_map.addListener(listener_guti);
	log.info("Consistent uekey_guti_map successfully listening");
...
//                log.info("context is already handled");
			...
			String ue_ip = uekey_ueip_map.get(tmpArray[2]).value(); // tmpArray[2] => ue key
