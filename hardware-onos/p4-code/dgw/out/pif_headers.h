...
/* uekey_uestate (5B) */
struct pif_header_uekey_uestate {
    unsigned int ue_key:32;
    unsigned int ue_state:8;
};

/* uekey_uestate field accessor macros */
#define PIF_HEADER_GET_uekey_uestate___ue_key(_hdr_p) (((_hdr_p)->ue_key)) /* uekey_uestate.ue_key [32;0] */

#define PIF_HEADER_SET_uekey_uestate___ue_key(_hdr_p, _val) \
    do { \
        (_hdr_p)->ue_key = (unsigned)(((_val))); \
    } while (0) /* uekey_uestate.ue_key[32;0] */

#define PIF_HEADER_GET_uekey_uestate___ue_state(_hdr_p) (((_hdr_p)->ue_state)) /* uekey_uestate.ue_state [8;0] */

#define PIF_HEADER_SET_uekey_uestate___ue_state(_hdr_p, _val) \
    do { \
        (_hdr_p)->ue_state = (unsigned)(((_val))); \
    } while (0) /* uekey_uestate.ue_state[8;0] */


/* uekey_guti (8B) */
struct pif_header_uekey_guti {
    unsigned int ue_key:32;
    unsigned int guti:32;
};

/* uekey_guti field accessor macros */
#define PIF_HEADER_GET_uekey_guti___ue_key(_hdr_p) (((_hdr_p)->ue_key)) /* uekey_guti.ue_key [32;0] */

#define PIF_HEADER_SET_uekey_guti___ue_key(_hdr_p, _val) \
    do { \
        (_hdr_p)->ue_key = (unsigned)(((_val))); \
    } while (0) /* uekey_guti.ue_key[32;0] */

#define PIF_HEADER_GET_uekey_guti___guti(_hdr_p) (((_hdr_p)->guti)) /* uekey_guti.guti [32;0] */

#define PIF_HEADER_SET_uekey_guti___guti(_hdr_p, _val) \
    do { \
        (_hdr_p)->guti = (unsigned)(((_val))); \
    } while (0) /* uekey_guti.guti[32;0] */


/* ingress::tmpreg (16B) */
struct pif_header_ingress__tmpreg {
    unsigned int port_index:32;
    unsigned int ue_key:32;
    unsigned int srcAddr:32;
    unsigned int dstAddr:32;
};

/* ingress::tmpreg field accessor macros */
#define PIF_HEADER_GET_ingress__tmpreg___port_index(_hdr_p) (((_hdr_p)->port_index)) /* ingress::tmpreg.port_index [32;0] */

#define PIF_HEADER_SET_ingress__tmpreg___port_index(_hdr_p, _val) \
    do { \
        (_hdr_p)->port_index = (unsigned)(((_val))); \
    } while (0) /* ingress::tmpreg.port_index[32;0] */

#define PIF_HEADER_GET_ingress__tmpreg___ue_key(_hdr_p) (((_hdr_p)->ue_key)) /* ingress::tmpreg.ue_key [32;0] */

#define PIF_HEADER_SET_ingress__tmpreg___ue_key(_hdr_p, _val) \
    do { \
        (_hdr_p)->ue_key = (unsigned)(((_val))); \
    } while (0) /* ingress::tmpreg.ue_key[32;0] */

#define PIF_HEADER_GET_ingress__tmpreg___srcAddr(_hdr_p) (((_hdr_p)->srcAddr)) /* ingress::tmpreg.srcAddr [32;0] */

#define PIF_HEADER_SET_ingress__tmpreg___srcAddr(_hdr_p, _val) \
    do { \
        (_hdr_p)->srcAddr = (unsigned)(((_val))); \
    } while (0) /* ingress::tmpreg.srcAddr[32;0] */

#define PIF_HEADER_GET_ingress__tmpreg___dstAddr(_hdr_p) (((_hdr_p)->dstAddr)) /* ingress::tmpreg.dstAddr [32;0] */

#define PIF_HEADER_SET_ingress__tmpreg___dstAddr(_hdr_p, _val) \
    do { \
        (_hdr_p)->dstAddr = (unsigned)(((_val))); \
    } while (0) /* ingress::tmpreg.dstAddr[32;0] */
...
/* s3_uplink_egress_port (4B) */
struct pif_header_s3_uplink_egress_port {
    unsigned int _padding_0:16;
    unsigned int value:16;
};

/* s3_uplink_egress_port field accessor macros */
#define PIF_HEADER_GET_s3_uplink_egress_port___value(_hdr_p) (((_hdr_p)->value)) /* s3_uplink_egress_port.value [16;0] */

#define PIF_HEADER_SET_s3_uplink_egress_port___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* s3_uplink_egress_port.value[16;0] */

#define PIF_HEADER_GET_s3_uplink_egress_port____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* s3_uplink_egress_port._padding_0 [16;0] */

#define PIF_HEADER_SET_s3_uplink_egress_port____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* s3_uplink_egress_port._padding_0[16;0] */


/* tun_s1_uplink_egress_port (4B) */
struct pif_header_tun_s1_uplink_egress_port {
    unsigned int _padding_0:16;
    unsigned int value:16;
};

/* tun_s1_uplink_egress_port field accessor macros */
#define PIF_HEADER_GET_tun_s1_uplink_egress_port___value(_hdr_p) (((_hdr_p)->value)) /* tun_s1_uplink_egress_port.value [16;0] */

#define PIF_HEADER_SET_tun_s1_uplink_egress_port___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* tun_s1_uplink_egress_port.value[16;0] */

#define PIF_HEADER_GET_tun_s1_uplink_egress_port____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* tun_s1_uplink_egress_port._padding_0 [16;0] */

#define PIF_HEADER_SET_tun_s1_uplink_egress_port____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* tun_s1_uplink_egress_port._padding_0[16;0] */
