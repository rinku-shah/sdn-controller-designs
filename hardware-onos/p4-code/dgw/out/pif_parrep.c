...
__label_parse_initial_ctxt_setup_resp:
    { /* implementation of parse node parse_initial_ctxt_setup_resp */
...
#ifndef PIF_GLOBAL_FLOWCACHE_DISABLED
        {
            ...
            _pif_fk->initial_ctxt_setup_resp__ue_ip = initial_ctxt_setup_resp->ue_ip;
            (*_pif_parrep_fk_len) += 1;
        }
#endif
        goto _pif_parrep_label_exit;
...
#ifndef PIF_GLOBAL_FLOWCACHE_DISABLED
        {
            __lmem struct pif_global_flowkey_ue_context_rel_req *_pif_fk = (__lmem struct pif_global_flowkey_ue_context_rel_req *)(_pif_parrep_fk_ptr + (*_pif_parrep_fk_len));
            _pif_fk->ue_context_rel_req__ue_ip = ue_context_rel_req->ue_ip;
            _pif_fk->ue_context_rel_req__ue_num = ue_context_rel_req->ue_num;
            _pif_fk->ue_context_rel_req____ue_num_1 = ue_context_rel_req->__ue_num_1;
