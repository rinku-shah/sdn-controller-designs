...
/* get uekey_guti.ue_key */
uint32_t pif_plugin_meta_get__uekey_guti__ue_key(EXTRACTED_HEADERS_T *extracted_headers);

/* set uekey_guti.ue_key */
void pif_plugin_meta_set__uekey_guti__ue_key(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get uekey_guti.guti */
uint32_t pif_plugin_meta_get__uekey_guti__guti(EXTRACTED_HEADERS_T *extracted_headers);

/* set uekey_guti.guti */
void pif_plugin_meta_set__uekey_guti__guti(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
__forceinline uint32_t pif_plugin_meta_get__uekey_guti__ue_key(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_uekey_guti *md = (__lmem struct pif_header_uekey_guti *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_guti_OFF_LW);
    return PIF_HEADER_GET_uekey_guti___ue_key(md);
}

__forceinline void pif_plugin_meta_set__uekey_guti__ue_key(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_uekey_guti *md = (__lmem struct pif_header_uekey_guti *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_guti_OFF_LW);
    PIF_HEADER_SET_uekey_guti___ue_key(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__uekey_guti__guti(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_uekey_guti *md = (__lmem struct pif_header_uekey_guti *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_guti_OFF_LW);
    return PIF_HEADER_GET_uekey_guti___guti(md);
}

__forceinline void pif_plugin_meta_set__uekey_guti__guti(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_uekey_guti *md = (__lmem struct pif_header_uekey_guti *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_guti_OFF_LW);
    PIF_HEADER_SET_uekey_guti___guti(md, val);
}
