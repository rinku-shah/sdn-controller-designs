...
__packed_bits struct pif_global_flowkey_initial_ctxt_setup_resp {
    unsigned int initial_ctxt_setup_resp__ue_ip:32;
};

__packed_bits struct pif_global_flowkey_ue_context_rel_req {
    unsigned int ue_context_rel_req__ue_ip:32;
    unsigned int ue_context_rel_req__ue_num:16;
    unsigned int ue_context_rel_req____ue_num_1:16;
};
