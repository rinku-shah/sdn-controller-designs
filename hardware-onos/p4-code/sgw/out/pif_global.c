...
{
    __lmem struct pif_header_tmpreg *tmpreg = (__lmem struct pif_header_tmpreg *)(parrep + PIF_PARREP_tmpreg_OFF_LW);
    __lmem struct pif_header_scalars *scalars = (__lmem struct pif_header_scalars *)(parrep + PIF_PARREP_scalars_OFF_LW);
    __lmem struct pif_header_tmpvar *tmpvar = (__lmem struct pif_header_tmpvar *)(parrep + PIF_PARREP_tmpvar_OFF_LW);
    ...
    scalars->pred_0 = 0x0;
    scalars->pred = 0x0;
    tmpvar->tmpUdpPort = 0x0;
    tmpreg->tmp_index = 0x0;
    standard_metadata->instance_type = 0x0;
}
