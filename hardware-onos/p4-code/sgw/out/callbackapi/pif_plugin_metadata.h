...
/* get uekey_uestate.ue_key */
uint32_t pif_plugin_meta_get__uekey_uestate__ue_key(EXTRACTED_HEADERS_T *extracted_headers);

/* set uekey_uestate.ue_key */
void pif_plugin_meta_set__uekey_uestate__ue_key(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get uekey_uestate.ue_state */
uint32_t pif_plugin_meta_get__uekey_uestate__ue_state(EXTRACTED_HEADERS_T *extracted_headers);

/* set uekey_uestate.ue_state */
void pif_plugin_meta_set__uekey_uestate__ue_state(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get tmpvar.tmpUdpPort */
uint32_t pif_plugin_meta_get__tmpvar__tmpUdpPort(EXTRACTED_HEADERS_T *extracted_headers);

/* set tmpvar.tmpUdpPort */
void pif_plugin_meta_set__tmpvar__tmpUdpPort(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
/* get tmpreg.tmp_index */
uint32_t pif_plugin_meta_get__tmpreg__tmp_index(EXTRACTED_HEADERS_T *extracted_headers);

/* set tmpreg.tmp_index */
void pif_plugin_meta_set__tmpreg__tmp_index(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get tmpreg.ue_key */
uint32_t pif_plugin_meta_get__tmpreg__ue_key(EXTRACTED_HEADERS_T *extracted_headers);

/* set tmpreg.ue_key */
void pif_plugin_meta_set__tmpreg__ue_key(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
/* get scalars.pred_0 */
uint32_t pif_plugin_meta_get__scalars__pred_0(EXTRACTED_HEADERS_T *extracted_headers);

/* set scalars.pred_0 */
void pif_plugin_meta_set__scalars__pred_0(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
__forceinline uint32_t pif_plugin_meta_get__uekey_uestate__ue_key(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_uekey_uestate *md = (__lmem struct pif_header_uekey_uestate *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_uestate_OFF_LW);
    return PIF_HEADER_GET_uekey_uestate___ue_key(md);
}

__forceinline void pif_plugin_meta_set__uekey_uestate__ue_key(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_uekey_uestate *md = (__lmem struct pif_header_uekey_uestate *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_uestate_OFF_LW);
    PIF_HEADER_SET_uekey_uestate___ue_key(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__uekey_uestate__ue_state(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_uekey_uestate *md = (__lmem struct pif_header_uekey_uestate *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_uestate_OFF_LW);
    return PIF_HEADER_GET_uekey_uestate___ue_state(md);
}

__forceinline void pif_plugin_meta_set__uekey_uestate__ue_state(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_uekey_uestate *md = (__lmem struct pif_header_uekey_uestate *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_uekey_uestate_OFF_LW);
    PIF_HEADER_SET_uekey_uestate___ue_state(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__tmpvar__tmpUdpPort(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_tmpvar *md = (__lmem struct pif_header_tmpvar *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpvar_OFF_LW);
    return PIF_HEADER_GET_tmpvar___tmpUdpPort(md);
}

__forceinline void pif_plugin_meta_set__tmpvar__tmpUdpPort(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_tmpvar *md = (__lmem struct pif_header_tmpvar *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpvar_OFF_LW);
    PIF_HEADER_SET_tmpvar___tmpUdpPort(md, val);
}
...
__forceinline uint32_t pif_plugin_meta_get__tmpreg__tmp_index(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_tmpreg *md = (__lmem struct pif_header_tmpreg *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpreg_OFF_LW);
    return PIF_HEADER_GET_tmpreg___tmp_index(md);
}

__forceinline void pif_plugin_meta_set__tmpreg__tmp_index(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_tmpreg *md = (__lmem struct pif_header_tmpreg *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpreg_OFF_LW);
    PIF_HEADER_SET_tmpreg___tmp_index(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__tmpreg__ue_key(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_tmpreg *md = (__lmem struct pif_header_tmpreg *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpreg_OFF_LW);
    return PIF_HEADER_GET_tmpreg___ue_key(md);
}

__forceinline void pif_plugin_meta_set__tmpreg__ue_key(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_tmpreg *md = (__lmem struct pif_header_tmpreg *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_tmpreg_OFF_LW);
    PIF_HEADER_SET_tmpreg___ue_key(md, val);
}
...
__forceinline uint32_t pif_plugin_meta_get__scalars__pred_0(EXTRACTED_HEADERS_T *extracted_headers)
{
    ...
    return PIF_HEADER_GET_scalars___pred_0(md);
}

__forceinline void pif_plugin_meta_set__scalars__pred_0(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    PIF_HEADER_SET_scalars___pred_0(md, val);
}
