...
/* tmpreg (8B) */
struct pif_header_tmpreg {
    unsigned int tmp_index:32;
    unsigned int ue_key:32;
};

/* tmpreg field accessor macros */
#define PIF_HEADER_GET_tmpreg___tmp_index(_hdr_p) (((_hdr_p)->tmp_index)) /* tmpreg.tmp_index [32;0] */

#define PIF_HEADER_SET_tmpreg___tmp_index(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmp_index = (unsigned)(((_val))); \
    } while (0) /* tmpreg.tmp_index[32;0] */

#define PIF_HEADER_GET_tmpreg___ue_key(_hdr_p) (((_hdr_p)->ue_key)) /* tmpreg.ue_key [32;0] */

#define PIF_HEADER_SET_tmpreg___ue_key(_hdr_p, _val) \
    do { \
        (_hdr_p)->ue_key = (unsigned)(((_val))); \
    } while (0) /* tmpreg.ue_key[32;0] */
...
struct pif_header_scalars {
    unsigned int pred_0:1;
    unsigned int hasReturned_0:1;
    unsigned int pred:1;
    unsigned int _padding_0:29;
};

/* scalars field accessor macros */
#define PIF_HEADER_GET_scalars___pred_0(_hdr_p) (((_hdr_p)->pred_0)) /* scalars.pred_0 [1;0] */

#define PIF_HEADER_SET_scalars___pred_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->pred_0 = (unsigned)(((_val))); \
    } while (0) /* scalars.pred_0[1;0] */

#define PIF_HEADER_GET_scalars___hasReturned_0(_hdr_p) (((_hdr_p)->hasReturned_0)) /* scalars.hasReturned_0 [1;0] */

#define PIF_HEADER_SET_scalars___hasReturned_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->hasReturned_0 = (unsigned)(((_val))); \
    } while (0) /* scalars.hasReturned_0[1;0] */

#define PIF_HEADER_GET_scalars___pred(_hdr_p) (((_hdr_p)->pred)) /* scalars.pred [1;0] */

#define PIF_HEADER_SET_scalars___pred(_hdr_p, _val) \
    do { \
        (_hdr_p)->pred = (unsigned)(((_val))); \
    } while (0) /* scalars.pred[1;0] */

#define PIF_HEADER_GET_scalars____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* scalars._padding_0 [29;0] */

#define PIF_HEADER_SET_scalars____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* scalars._padding_0[29;0] */
...
/* reg_uestate (4B) */
struct pif_header_reg_uestate {
    unsigned int _padding_0:24;
    unsigned int value:8;
};

/* reg_uestate field accessor macros */
#define PIF_HEADER_GET_reg_uestate___value(_hdr_p) (((_hdr_p)->value)) /* reg_uestate.value [8;0] */

#define PIF_HEADER_SET_reg_uestate___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* reg_uestate.value[8;0] */

#define PIF_HEADER_GET_reg_uestate____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* reg_uestate._padding_0 [24;0] */

#define PIF_HEADER_SET_reg_uestate____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* reg_uestate._padding_0[24;0] */


/* s2_downlink_egress_port (4B) */
struct pif_header_s2_downlink_egress_port {
    unsigned int _padding_0:16;
    unsigned int value:16;
};

/* s2_downlink_egress_port field accessor macros */
#define PIF_HEADER_GET_s2_downlink_egress_port___value(_hdr_p) (((_hdr_p)->value)) /* s2_downlink_egress_port.value [16;0] */

#define PIF_HEADER_SET_s2_downlink_egress_port___value(_hdr_p, _val) \
    do { \
        (_hdr_p)->value = (unsigned)(((_val))); \
    } while (0) /* s2_downlink_egress_port.value[16;0] */

#define PIF_HEADER_GET_s2_downlink_egress_port____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* s2_downlink_egress_port._padding_0 [16;0] */

#define PIF_HEADER_SET_s2_downlink_egress_port____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* s2_downlink_egress_port._padding_0[16;0] */
