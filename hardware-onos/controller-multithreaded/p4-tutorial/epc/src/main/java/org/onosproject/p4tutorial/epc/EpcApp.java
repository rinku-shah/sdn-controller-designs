...
//    private AtomicInteger nextTunnelId = new AtomicInteger();
    ...
    public OnlineDesignAdaptation online;
    ...
    public void activate() {
        ...
        requestIntercepts();
	online = new OnlineDesignAdaptation(appId);
...
//                             d2 = new Date();
        ...
        //Populate state at local controllers instead of switch
        //sendState(dgw_dpId, action (DEL/PUT), map_Name, key, value) //even delete is considered put
        private void sendState(String dgw_dpId, String action, String map_Name, int key, int value){
