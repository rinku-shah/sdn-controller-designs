...
dg1=`sudo lxc-info -p -n offload_dgw1|tr -d ' '|cut -d ':' -f2`
dg2=`sudo lxc-info -p -n offload_dgw2|tr -d ' '|cut -d ':' -f2`
dg3=`sudo lxc-info -p -n offload_dgw3|tr -d ' '|cut -d ':' -f2`
dg4=`sudo lxc-info -p -n offload_dgw4|tr -d ' '|cut -d ':' -f2`
#dg5=`sudo lxc-info -p -n offload_dgw5|tr -d ' '|cut -d ':' -f2`
#dg6=`sudo lxc-info -p -n offload_dgw6|tr -d ' '|cut -d ':' -f2`

sg1=`sudo lxc-info -p -n offload_sgw1|tr -d ' '|cut -d ':' -f2`
sg2=`sudo lxc-info -p -n offload_sgw2|tr -d ' '|cut -d ':' -f2`
sg3=`sudo lxc-info -p -n offload_sgw3|tr -d ' '|cut -d ':' -f2`
sg4=`sudo lxc-info -p -n offload_sgw4|tr -d ' '|cut -d ':' -f2`
#sg5=`sudo lxc-info -p -n offload_sgw5|tr -d ' '|cut -d ':' -f2`
#sg6=`sudo lxc-info -p -n offload_sgw6|tr -d ' '|cut -d ':' -f2`

pg=`sudo lxc-info -p -n pgw|tr -d ' '|cut -d ':' -f2`

ran1=`sudo lxc-info -p -n offload_ran1|tr -d ' '|cut -d ':' -f2`
ran2=`sudo lxc-info -p -n offload_ran2|tr -d ' '|cut -d ':' -f2`
ran3=`sudo lxc-info -p -n offload_ran3|tr -d ' '|cut -d ':' -f2`
ran4=`sudo lxc-info -p -n offload_ran4|tr -d ' '|cut -d ':' -f2`
...
sh cpu_util.sh $1 $2 $sg1 sgw1_util.txt tmp_s1 $3 "^%Cpu24 \|^%Cpu25 \|^%Cpu43 " & 

sh cpu_util.sh $1 $2 $sg2 sgw2_util.txt tmp_s2 $3 "^%Cpu26 \|^%Cpu27 \|^%Cpu44 " & 

sh cpu_util.sh $1 $2 $sg3 sgw3_util.txt tmp_s3 $3 "^%Cpu28 \|^%Cpu29 \|^%Cpu45 " & 

sh cpu_util.sh $1 $2 $sg4 sgw4_util.txt tmp_s4 $3 "^%Cpu30 \|^%Cpu31 \|^%Cpu46 " & 
